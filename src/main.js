...
const ring=new THREE.Mesh(new THREE.RingGeometry(5.45,5.46,128),new THREE.MeshBasicMaterial({color:0x61776f,transparent:true,opacity:.16,side:THREE.DoubleSide}));ring.rotation.x=-Math.PI/2;ring.position.y=.001;scene.add(ring);
