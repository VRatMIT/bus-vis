...
export function materials(){
 // Subtle microstructure beneath a smooth clear coat, rather than visible glitter.
 ...
 return {
 paint:new T.MeshPhysicalMaterial({color:0x08677a,metalness:.48,roughness:.27,clearcoat:1,clearcoatRoughness:.065,normalMap:normal,normalScale:new T.Vector2(.075,.075),envMapIntensity:1.15}),
...
export function studioEnvironment(){
 ...
 panel(14,5,[-3,8,1],[0,0,0],4,'#fff8ed');
 panel(16,2,[1,3.5,7],[0,1,0],3,'#e5f3ff');
 panel(12,1.2,[0,2,-7],[0,1,0],2.8,'#ffffff');
 panel(3,7,[-8,3,-3],[0,1,0],2,'#e6f0ff');
